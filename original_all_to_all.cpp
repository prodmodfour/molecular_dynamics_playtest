...
double evaluate_forces()
{
 ...
 for (int i = 0; i < number_atoms; i++)
 {
    ...
    double cumulative_fxij = Atoms[i].fx;
    double cumulative_fyij = Atoms[i].fy;
    double cumulative_fzij = Atoms[i].fz;
    ...
    for (int j = i + 1; j < number_atoms; j++)
    {
        ...
        cumulative_fxij += fxij;
        cumulative_fyij += fyij;
        cumulative_fzij += fzij;
    ...
    // Update force on atom i
    Atoms[i].fx = cumulative_fxij;
    Atoms[i].fy = cumulative_fyij;
    Atoms[i].fz = cumulative_fzij;
